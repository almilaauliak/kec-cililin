...
<section id="detail">
    <div class="container col-xxl-8 d-flex justify-content-center">   
        <div class="card bg-white col-xxl-8 text-left border-0">
            <p class="">
                <a href="/" class="text-decoration-none text-dark"> Beranda</a> / <a href="/index/berita" class="text-decoration-none text-dark"> Berita</a> / {{$artikel->judul}}
            </p>
           ...
           <!-- <img src="{{asset('storage/artikel/'.$artikel->image) }}" class="img-fluid rounded-3 mb-3 col-xl-8" alt="" >-->
            <img src="{{ asset('storage/' . $artikel->image) }}" class="img-fluid rounded-3 mb-3 col-xl-8" alt="" >
            {!! $artikel->desc !!}
        </div>
    </div>
